...
function NavIcon({ name }: { name: "grid" | "box" | "alert" | "orders" | "logout" }) {
  const paths = {
...
export function AppSidebar({ user, active, productCount, lowStockCount, orderCount = 0, onInventoryFilter }: AppSidebarProps) {
